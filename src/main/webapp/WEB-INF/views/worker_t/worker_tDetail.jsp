...
<%@ include file="../header.jsp" %>
	...
	<section class="ftco-section">
		<div class="boardcontainer">
			<h3 class="h3 mb-4 text-center">${m1t.subject}</h3>
			<hr>
		    ...
		    <h5 class="h5 mb-4 text-left">주소 : ${m1t.address}</h5>
		    <h5 class="h5 mb-4 text-left">전화번호 : ${m1t.phone}</h5>
		    <h5 class="h5 mb-4 text-left">편의시설 : ${m1t.convenience}</h5>
			<hr>
			<h5 class="h5 mb-4 text-center">상세 정보</h5>
			<p id="detailcontent">${m1t.content}</p>
			<div id="map" style="width:940px;height:400px;margin-bottom:40px"></div>
			<hr>
			<input id="address" type="hidden" value="${m1t.address}">
		</div>
	</section>
