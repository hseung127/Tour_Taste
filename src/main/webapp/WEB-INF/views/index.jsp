...
<%@ include file="loading.jsp" %>  
      ...
      <section class="section section-md bg-default">
        <div class="container">
          <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown">관리자 추천 관광지</span></h3>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-leaf"><!--  ${homeM1tList[0].area}--></span>
                    <h5 class="services-terri-title">${homeM1tList[0].subject}<a href="#"></a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-pizza"></span>
                    <h5 class="services-terri-title"><a href="#">${homeM1tList[1].subject}</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-hamburger"></span>
                    <h5 class="services-terri-title"><a href="#">${homeM1tList[2].subject}</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-ice-cream"></span>
                    <h5 class="services-terri-title"><a href="#">${homeM1tList[3].subject}</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-coffee-cup"></span>
                    <h5 class="services-terri-title"><a href="#">${homeM1tList[4].subject}</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-steak"></span>
                    <h5 class="services-terri-title"><a href="#">${homeM1tList[5].subject}</a></h5>
                  </div>
                </article>
              </div>
            </div>
			         ...
			         <div class="top_cont clfix">
			            ...
			            <div class="top_leftCont">   
			                ...
			                <div class="article bd0">
			                    <a href="/notice/news_list.do" class="tit_atc">
			                       	 오늘의 여행  Issue
			                        <span class="btn_more">더보기</span>
			                    </a>
			                    <ul class="list_board">
			                        <li>
			                            <a href="#" title="방문 전 여행정보 변동사항 로 이동"><!-- <em style="color:#a2660d">코로나바이러스감염증-19ㅣ</em> -->${homeNewsList[0].subject}</a>
			                        </li>
			                        <li>
			                            <a href="#" title="관광 분야 코로나19 사회적 거리 두기 방역 수칙 로 이동"><!-- <em style="color:#a2660d">안전여행 가이드ㅣ</em> -->${homeNewsList[1].subject}</a>
			                        </li>
			                        <li>
			                            <a href="#"  title="제13회 관광벤처사업 공모전 로 이동"><!-- <em style="color:#a2660d">한국관광공사ㅣ</em> -->${homeNewsList[2].subject}</a>
			                        </li>
			                        <li>
			                            <a href="#" title="원주 소금산 그랜드밸리 그랜드 오픈! 로 이동"><!-- <em style="color:#a2660d">강원도여행 |</em> -->${homeNewsList[3].subject}</a>
			                        </li>
			                    </ul>
			                </div>
				                ...
				                <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
				                    ...
				                    <ul class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1395px, 0px, 0px);">
				                        ...
				                        <li class="swiper-slide swiper-slide-duplicate swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="1" style="width: 465px;">	
				                            <ul>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="트래블리더 14기 모집!" style="background-color: #ffffff;" src="images/event/${homeEventList[0].homeimg}"></a>
				                                </li>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="탄소 배출량 줄이는 친환경 추천 여행지! 친추 여행지" style="background-color: #ffffff;" src="images/event/${homeEventList[1].homeimg}"></a>
				                                </li>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="배우 정해인 목소리로 듣는 오디오 가이드 오디! 남양주 정약용 유적지" style="background-color: #ffffff;" src="images/event/${homeEventList[2].homeimg}"></a>
				                                </li>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="함께 떠나는 랜선 축제 여행! 대한민국 축제의 모든 것!" style="background-color: #ffffff;" src="images/event/${homeEventList[3].homeimg}"></a>
				                                </li>	
				                            </ul>
				                        </li>
				                        ...
				                        <li class="swiper-slide swiper-slide-duplicate-active" data-swiper-slide-index="0" style="width: 465px;">	
				                            <ul>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="가볼래-터와 함께 여행을 구독하세요!" style="background-color: #ebe8fd;" src="images/event/${homeEventList[4].homeimg}"></a>
				                                </li>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="최애 맛집 제보 이벤트! 그곳이 알고싶다" style="background-color: #fff6de;" src="images/event/${homeEventList[5].homeimg}"></a>
				                                </li>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="최초이거나 유일하거나! 레어템으로 소문난 관광지!" style="background-color: #def6ff;" src="images/event/${homeEventList[6].homeimg}"></a>
				                                </li>		
				                                <li>
				                                    <a href="#"><img class="swiper-lazy swiper-lazy-loaded" alt="월간 19투어 여수편! 여수의 숨은 매력을 발견해보세요!" style="background-color: #fdf0f2;" src="images/event/${homeEventList[7].homeimg}"></a>
				                                </li>	
				                            </ul>
				                        </li>
					                ...
					                <div class="paging">
				                    	...
				                    	<div class="swiper-pagination swiper-pagination-clickable swiper-pagination-bullets">
				                    		<button type="button" class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 1">
				                    			<span class="blind">1번째 슬라이드 보기</span>
				                    		</button>
				                    		<button type="button" class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 2">
      ...
      <div class="container">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">
              ...
              <article class="product wow fadeInLeft" data-wow-delay=".15s">
                ...
                <div class="product-button">
                  <%-- <div class="button-wrap"><a class="button button-xs button-primary button-winona" href="insert_bookmark_m1r?m1rseq=${homeM1rList[0].m1rseq}">즐겨찾기 추가</a></div> --%>
                  ...
                  <div class="button-wrap"><a class="button button-xs button-secondary button-winona" href="#">상세보기</a></div>
                </div>
              </article>
            </div>
        ...
        <!-- <div class="container"> -->
         <!--  <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp">회원 추천 음식점</span></h3> -->
          ...
          <br>
          <h5 style="float:left; left:345px;"> ㅣ 회원 추천 맛집 </h5> <br>        	
