...
<div>
	<ul id="search-pagination">
		...
		<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="index">
			<a href='javascript:void(0);' onclick="go_search_index(this);" class="p-index" id="p-index${index}"data-index="${index}" data-index-url="${pageMaker.makeQuery(index)}">${index}</a>
